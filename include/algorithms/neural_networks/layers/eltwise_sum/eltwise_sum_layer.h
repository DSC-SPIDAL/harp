...
/*
//++
//  Implementation of element-wise sum neural network layer.
//--
*/

#ifndef __ELTWISE_SUM_LAYER_H__
#define __ELTWISE_SUM_LAYER_H__
...
#include "algorithms/neural_networks/layers/eltwise_sum/eltwise_sum_layer_forward.h"
#include "algorithms/neural_networks/layers/eltwise_sum/eltwise_sum_layer_backward.h"
...
{
/**
 * \brief Contains classes for neural network element-wise sum layer
 */
 ...
 */
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__ELTWISE_SUM__BATCH"></a>
 * \brief Computes the result of the forward and backward element-wise sum layer of neural network in the batch processing mode
 ...
 *
 * \tparam algorithmFPType Data type to use in intermediate computations for the element-wise sum layer, double or float
 * \tparam method          %Batch element-wise sum layer computation method, \ref Method
 *
 * \par Enumerations
