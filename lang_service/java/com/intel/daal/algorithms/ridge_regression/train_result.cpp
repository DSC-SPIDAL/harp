...
#include "ridge_regression/training/JTrainingResult.h"
#include "ridge_regression/training/JTrainingResultId.h"
...
/*
 * Class:     com_intel_daal_algorithms_ridge_regression_training_TrainingResult
 * Method:    cNewResult
 * Signature: ()J
 */
