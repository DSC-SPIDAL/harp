...
DMLC_REGISTRY_FILE_TAG(updater_bindidcache);

template<typename TStats>
class HistMakerBinid: public BaseMaker {
 public:
...
template<typename TStats>
class CQHistMakerBinid: public HistMakerBinid<TStats> {
 public:
  CQHistMakerBinid()  = default;

 protected:
  struct HistEntry {
    typename HistMakerBinid<TStats>::HistUnit hist;
    unsigned istart;
...
// global proposal
template<typename TStats>
class GlobalProposalHistMakerBinid: public CQHistMakerBinid<TStats> {

 public:
  GlobalProposalHistMakerBinid(){
...
//XGBOOST_REGISTER_TREE_UPDATER(LocalHistMakerBinid, "grow_local_histmaker")
//.describe("Tree constructor that uses approximate histogram construction.")
//.set_body([]() {
//    return new CQHistMakerBinid<GradStats>();
//  });
//
//XGBOOST_REGISTER_TREE_UPDATER(GlobalHistMakerBinid, "grow_global_histmaker")
//.describe("Tree constructor that uses approximate global proposal of histogram construction.")
//.set_body([]() {
//    return new GlobalProposalHistMakerBinid<GradStats>();
//  });

XGBOOST_REGISTER_TREE_UPDATER(HistMakerBinid, "grow_binidcache")
