...
{
public:
    explicit UniquePtr(T *object = nullptr, bool disableDeletingFlag = false) :
        _object(object), _disableDeletingFlag(disableDeletingFlag) { }

    UniquePtr(UniquePtr<T, cpu> &&other) :
        _object(other.release()), _disableDeletingFlag(other._disableDeletingFlag) { }
    ...
    {
        _disableDeletingFlag = other._disableDeletingFlag;
        _object = other.release();
        return *this;
    }

    void reset(T *object = nullptr, bool disableDeletingFlag = false)
    {
        if (_object && !_disableDeletingFlag) { delete _object; }
        _object  = object;
        _disableDeletingFlag = disableDeletingFlag;
    }
...
public:
    ...
    TArrayScalable(const TArrayScalable&) = delete;
    T* get() { return _data; }
    ...
    TArrayScalable &operator = (const TArrayScalable &) = delete;
...
public:
    ...
    TArrayCalloc(const TArrayCalloc&) = delete;
    T* get() { return _data; }
    const T* get() const { return _data; }
    size_t size() const { return _size; }
    ...
    TArrayCalloc &operator = (const TArrayCalloc &) = delete;
...
public:
    ...
    TNArray &operator = (const TNArray &) = delete;
