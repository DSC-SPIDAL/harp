...
/**
 * <a name="DAAL-CLASS-DATA_MANAGEMENT__DATA__HARPTENSOR"></a>
 ...
 *        Optimized for Harp-DAAL
 */
public class HarpTensor extends Tensor {
     ...
     */
    public HarpTensor(DaalContext context, HarpTensorImpl impl) {
        super(context);
        tensorImpl = impl;
    }

    /**
     * Constructs homogeneous harp tensor from the array of doubles
     *
     * @param context   Context to manage created homogeneous tensor
     * @param dims      Dimensions of the tensor
     * @param data      Array with the tensor data
     */
    public HarpTensor(DaalContext context, long[] dims, double[] data) {
        super(context);
        tensorImpl = new HarpTensorArrayImpl(context, dims, data);
    }
     ...
     * @param data      Array with the tensor data
     */
    public HarpTensor(DaalContext context, long[] dims, float[] data) {
        super(context);
        tensorImpl = new HarpTensorArrayImpl(context, dims, data);
    }
     ...
     * @param data      Array with the tensor data
     */
    public HarpTensor(DaalContext context, long[] dims, int[] data) {
        super(context);
        tensorImpl = new HarpTensorArrayImpl(context, dims, data);
    }
     ...
     * @param data      Array with the tensor data
     */
    public HarpTensor(DaalContext context, long[] dims, long[] data) {
        super(context);
        tensorImpl = new HarpTensorArrayImpl(context, dims, data);
    }
     ...
     */
    public HarpTensor(DaalContext context, long[] dims, double[] data, double constValue) {
        super(context);
        tensorImpl = new HarpTensorArrayImpl(context, dims, data, constValue);
    }
     ...
     * @param constValue Constant to initialize entries of the homogeneous tensor
     */
    public HarpTensor(DaalContext context, long[] dims, float[] data, float constValue) {
        super(context);
        tensorImpl = new HarpTensorArrayImpl(context, dims, data, constValue);
    }
     ...
     * @param constValue Constant to initialize entries of the homogeneous tensor
     */
    public HarpTensor(DaalContext context, long[] dims, int[] data, int constValue) {
        super(context);
        tensorImpl = new HarpTensorArrayImpl(context, dims, data, constValue);
    }
     ...
     * @param constValue Constant to initialize entries of the homogeneous tensor
     */
    public HarpTensor(DaalContext context, long[] dims, long[] data, long constValue) {
        super(context);
        tensorImpl = new HarpTensorArrayImpl(context, dims, data, constValue);
    }
    ...
    //  */
    // public HarpTensor(DaalContext context, long cObject) {
    //     super(context);
    ...
    public DoubleBuffer getSubtensor(long[] fixedDims, long rangeDimIdx, long rangeDimNum, DoubleBuffer buf) {
        return ((HarpTensorImpl)tensorImpl).getSubtensor(fixedDims, rangeDimIdx, rangeDimNum, buf);
    }
    ...
    public void releaseSubtensor(long[] fixedDims, long rangeDimIdx, long rangeDimNum, FloatBuffer buf) {
        ((HarpTensorImpl)tensorImpl).releaseSubtensor(fixedDims, rangeDimIdx, rangeDimNum, buf);
    }
    ...
    public Object getDataObject() {
        return ((HarpTensorImpl)tensorImpl).getDataObject();
    }
    ...
    public Class<? extends Number> getNumericType() {
        return ((HarpTensorImpl)tensorImpl).getNumericType();
    }
}
/** @} */
