...
sec=80 # around 10 itrs for warplad 8 threads 
...
# exe_dir=${CurDir}
exe_dir=/N/u/lc37/Project/l_mklb_p_2018.3.011/benchmarks_2018/linux/mkl/benchmarks/linpack/
# scriptName=run_sc_mat.sh
# scriptName=run_sc_mat_t-006.sh
scriptName=runme_xeon64
# scriptName=run_sc_vec.sh
# executor=sc-skl-icc.bin
executor=xlinpack_xeon64
...
obj=R-$Arch-$executor-$run_arg1-$run_arg2-$run_arg3-$action-$type-vectorization
# obj=R-$Arch-$executor-$run_arg1-$run_arg2-$run_arg3-$action-$type-memcache
# obj=R-$Arch-$executor-$run_arg1-$run_arg2-$run_arg3-$action-$type
# resDir=/scratch_hdd/lc37/VTuneRes/$obj
# mkdir -p ${CurDir}/VTuneResult
resDir=${CurDir}/VTuneResult/$obj
reportDir=$CurDir
