...
protected:
    ...
    void initialize()
    {
        ...
        _in = &input;
        _par = &parameter;
        _partialResult.reset(new DistributedPartialResultStep1());
    }
};
...
protected:
    ...
    void initialize()
    {
        ...
        _in = &input;
        _par = &parameter;
        _partialResult.reset(new DistributedPartialResultStep3());
    }
};
...
protected:
    ...
    void initialize()
    {
        ...
        _in = &input;
        _par = &parameter;
        _partialResult.reset(new DistributedPartialResultStep4());
    }
};
/** @} */
} // namespace interface1
