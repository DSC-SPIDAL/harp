...
## Usage
```bash
hadoop jar harp-java-1.0-SNAPSHOT.jar edu.iu.sahad.rotation.SCMapCollective <number of map tasks> <useLocalMultiThread> <template> <graphDir> <outDir> <num threads per node>
```
### Concrete Usage Example
```bash
hadoop jar harp-java-1.0-SNAPSHOT.jar edu.iu.sahad.rotation.SCMapCollective 2 1 templates/u5-1.t ./inputgraphfileloc ./outputharpsahad 5
```
