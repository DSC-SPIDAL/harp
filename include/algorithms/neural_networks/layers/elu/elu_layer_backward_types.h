/* file: elu_layer_backward_types.h */
/*******************************************************************************
...
/*
//++
//  Implementation of the backward Exponential Linear Unit (ELU) layer.
//--
*/

#ifndef __ELU_LAYER_BACKWARD_TYPES_H__
#define __ELU_LAYER_BACKWARD_TYPES_H__
 ...
 * \copydoc daal::algorithms::neural_networks::layers::elu::backward
 * @ingroup elu_layers
 * @{
 */
/**
...
{
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__ELU__BACKWARD__INPUT"></a>
 * \brief %Input objects for the backward ELU layer
 */
...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__NEURAL_NETWORKS__LAYERS__ELU__BACKWARD__RESULT"></a>
 * \brief Provides methods to access the result obtained with the compute() method of the backward ELU layer
 */
...
public:
    ...
    /**
     * Returns the result of the backward ELU layer
     */
    using layers::backward::Result::get;

    /**
    * Sets the result for the backward ELU layer
    */
