...
/**
 * <a name="DAAL-CLASS-DATA_MANAGEMENT__DATA__HARPNUMERICTABLE"></a>
 ...
 */
public class HarpNumericTable extends NumericTable {
    /** @private */
    static {
        System.loadLibrary("JavaAPI");
    }

    public HarpNumericTable(DaalContext context, HarpNumericTableImpl impl) {
        super(context);
        tableImpl = impl;
    }
     ...
     */
    public HarpNumericTable(DaalContext context, long nFeatures, long nVectors) {
        super(context);
        tableImpl = new HarpNumericTableImpl(context, nFeatures, nVectors);
    }
