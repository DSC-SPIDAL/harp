...
public:
    ...
    static CsvDataSourceOptions::Value unite(const CsvDataSourceOptions::Value &lhs,
                                             const CsvDataSourceOptions::Value &rhs)
    {
        return internal::DataSourceOptionsImpl<Value>::unite(lhs, rhs);
    }

    CsvDataSourceOptions(Value flags = byDefault) :
        _impl(flags) { }
    ...
    bool getParseHeaderFlag() const
    {
        return _impl.getFlag(parseHeader);
    }
...
public:
    ...
    {
        return _featureManager.getNumericTableNumberOfColumns();
    }
...
inline CsvDataSourceOptions::Value operator |(const CsvDataSourceOptions::Value &lhs,
                                              const CsvDataSourceOptions::Value &rhs)
