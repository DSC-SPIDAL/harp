...
Status UniformKernel<algorithmFPType, method, cpu>::compute(const uniform::Parameter<algorithmFPType> &parameter, NumericTable *resultTable)
{
    ...
    return compute(parameter, n, resultArray);
}

template<typename algorithmFPType, Method method, CpuType cpu>
Status UniformKernel<algorithmFPType, method, cpu>::compute(const uniform::Parameter<algorithmFPType> &parameter, size_t n, algorithmFPType *resultArray)
{
