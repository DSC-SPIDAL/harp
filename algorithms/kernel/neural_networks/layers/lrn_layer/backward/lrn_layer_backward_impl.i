        ...
        const lrn::Parameter &parameter)
{
    ...
    else
    {
        if(0.0 == beta)
        {
            ...
            return computeImplStatus<cpu>(inputGradientTensor, [ =, &inputGradientTensor, &gradientTensor ](size_t nFixedDims, size_t *fixedDims, size_t nRowsToProcess,
        ...
        if(targetDimPosition >= firstFreeDim)
        {
            ...
            return computeImplStatus<cpu>(inputGradientTensor,
        ...
        else
        {
            ...
            return computeImplStatus<cpu>(inputGradientTensor, [ =, &inputGradientTensor, &auxDataTensor, &sMinusBetaTensor, &gradientTensor ]
