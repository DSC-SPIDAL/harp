...
ModelQRInternal::ModelQRInternal(size_t featnum, size_t nrhs, const linear_regression::Parameter &par, modelFPType dummy) :
    super(featnum, nrhs, par, dummy)
{
    ...
    _rTable  .reset(new HomogenNumericTable<modelFPType>(dimWithoutBeta, dimWithoutBeta, NumericTable::doAllocate, 0));
    _qtyTable.reset(new HomogenNumericTable<modelFPType>(dimWithoutBeta, nrhs, NumericTable::doAllocate, 0));
}

template ModelQRInternal::ModelQRInternal(size_t featnum, size_t nrhs, const linear_regression::Parameter &par, DAAL_FPTYPE dummy);
}// namespace internal
}// namespace linear_regression
}// namespace algorithms
}// namespace daal
