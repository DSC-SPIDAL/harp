 ...
 * @brief Contains classes for gradient boosted trees classification models training
...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__GBT__CLASSIFICATION__TRAINING__TRAININGMETHOD"></a>
 * @brief Available methods for training gradient boosted trees classification models
 */
public final class TrainingMethod {
    ...
    /**
     * Default method. Second-order approximation of objective function,
