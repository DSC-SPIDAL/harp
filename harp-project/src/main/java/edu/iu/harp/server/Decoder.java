...
public class Decoder extends RecursiveAction {
    ...
    public Decoder(Data data, int selfID, EventType eventType, EventQueue eventQueue, DataMap dataMap) {
	this.data = data;
	this.selfID = selfID;
	...
	DataUtil.addDataToQueueOrMap(selfID, eventQueue, eventType, dataMap, data);
    }
}
