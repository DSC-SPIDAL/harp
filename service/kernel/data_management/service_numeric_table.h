...
public:
    ...
    static services::SharedPtr<HomogenNumericTableCPU<float, cpu> > create(float *const ptr, size_t featnum, size_t obsnum, services::Status *stat = NULL)
    {
...
public:
    ...
    static services::SharedPtr<HomogenNumericTableCPU<double, cpu> > create( double *const ptr, size_t featnum, size_t obsnum, services::Status *stat = NULL)
    {
...
public:
    ...
    static services::SharedPtr<HomogenNumericTableCPU<int, cpu> > create( int *const ptr, size_t featnum, size_t obsnum, services::Status *stat = NULL)
    {
