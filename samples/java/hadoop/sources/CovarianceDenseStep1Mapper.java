/* file: CovarianceDenseStep1Mapper.java */
/*******************************************************************************
...
public class CovarianceDenseStep1Mapper extends Mapper<Object, Text, IntWritable, WriteableData> {
    ...
    public void map(Object key, Text value,
        ...
        /* Read a data set */
        String filePath = "/Hadoop/CovarianceDense/data/" + value;
        ...
        DistributedStep1Local covarianceLocal = new DistributedStep1Local(daalContext, Double.class, Method.defaultDense);
