    ...
    NumericTable *batchIndices, OptionalArgument *optionalArgument, OptionalArgument *optionalResult)
{
    ...
    DAAL_CHECK_MALLOC(batchIndices || rngTask.init(optionalArgument, nTerms, parameter->seed, sgd::rngState));
    ...
    OptionalArgument *optionalArgument)
{
    ...
    if(!s)
        return s;
    algorithmFPType* workValue = mtWorkValue.get();
    ntWorkValue.reset(new HomogenNumericTableCPU<algorithmFPType, cpu>(workValue, 1, argumentSize));
