...
public class Constant {
    ...
    public static final long TERMINATION_TIMEOUT = 60L;
    ...
    public static final int LARGE_RETRY_COUNT = 10000;
    ...
    public static final int UNKNOWN_PARTITION_ID = Integer.MIN_VALUE;
}