...
services::Status ImplicitALSInitDistrKernel<algorithmFPType, fastCSR, cpu>::compute(
            ...
            NumericTable **userOffsets, NumericTable *itemsFactorsTable, const DistributedParameter *parameter)
{
    ...
    for (size_t i = 0; i < nItems; i++)
        DAAL_CHECK_STATUS(s, this->randFactors(1, nFactors, itemsFactors + i * nFactors, randBuffer.get(), parameter->engine));
