/* file: LowOrderMomentsDenseStep1Mapper.java */
/*******************************************************************************
...
public class LowOrderMomentsDenseStep1Mapper extends Mapper<Object, Text, IntWritable, WriteableData> {
    ...
    public void map(Object key, Text value,
        ...
        /* Read a data set */
        String filePath = "/Hadoop/LowOrderMomentsDense/data/" + value;
        ...
        DistributedStep1Local momentsLocal = new DistributedStep1Local(daalContext, Double.class, Method.defaultDense);
        momentsLocal.input.set( InputId.data, ntData );

        /* Compute low order moments on local node */
