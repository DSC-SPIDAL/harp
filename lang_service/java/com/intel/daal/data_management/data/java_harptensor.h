...
/*
//++
//  Implementation of the class that connects Java and C++ Tensors and optimized for 
//  Harp-DAAL 
//--
*/

#ifndef __JAVA_HARPTENSOR_H__
#define __JAVA_HARPTENSOR_H__
...
class JavaHarpTensorBase
{
public:
    virtual ~JavaHarpTensorBase() {}
 ...
 */
template<int Tag>
class DAAL_EXPORT JavaHarpTensor : public Tensor, public JavaHarpTensorBase
{
public:
    DECLARE_SERIALIZABLE_TAG();

    explicit JavaHarpTensor(): Tensor(&_layout), jvm(NULL), jJavaTensor(NULL), _layout(services::Collection<size_t>()) {}
     ...
     */
    JavaHarpTensor(Collection<size_t> &dims, JavaVM *_jvm, jobject _JavaTensor):
