...
{
public:
    DropoutKernel() : bernoulliParameter(0.5) {}
...
private:
    ...
    distributions::bernoulli::internal::BernoulliKernel<algorithmFPType, distributions::bernoulli::defaultDense, cpu> bernoulliKernel;
    distributions::bernoulli::Parameter<algorithmFPType> bernoulliParameter;
