...
public class HarpPageRank {
  public static void main(String[] args)
    ...
    if (args.length != 4) {
      String Usage = "Usage:: \n"
        + "hadoop jar <jar-file-name> edu.iu.simplepagerank.HarpPageRank "
    ...
    conf.setInt(PageRankConstants.NUM_ITERATONS,
      noIterations);
    conf.setInt(PageRankConstants.NUM_URLS,
      numUrls);

    Job job =
      Job.getInstance(conf, "harp page rank");
    JobConf jobConf =
