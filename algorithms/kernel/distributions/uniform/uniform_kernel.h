...
{
public:
    Status compute(const uniform::Parameter<algorithmFPType> &parameter, NumericTable *resultTable);
    Status compute(const uniform::Parameter<algorithmFPType> &parameter, size_t n, algorithmFPType *resultArray);
};
