...
# algoMode=1
# version=PFasciaThdScale
# version=FasciaThdScale
# version=TimeBreakExtra
version=ErrorBar
...
# for graph_file in RMAT-Data-sk-8-nV-4000000-nE-100000000.fascia
# for graph_file in orkut.graph
# for graph_file in nyc.graph
for graph_file in graph500-scale20-ef16_adj.mmio graph500-scale21-ef16_adj.mmio graph500-scale22-ef16_adj.mmio miami.graph orkut.graph nyc.graph
...
do
    ...
    do
        ...
        for tpproc in 48
        # for tpproc in 96 24 12 8 4 2 1
        do
