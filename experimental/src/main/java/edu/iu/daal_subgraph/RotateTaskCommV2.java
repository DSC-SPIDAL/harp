...
public class RotateTaskCommV2 implements Runnable {
    ...
    protected static final Log LOG = LogFactory.getLog(RotateTaskCommV2.class);
    private static DaalContext daal_Context = new DaalContext();

    //constructor
    RotateTaskCommV2(int local_mapper_id, int mapper_num,
