...
*/
struct DfRegJavaNodeVisitor : public daal::algorithms::regression::TreeNodeVisitor, public JavaCallback
{
    DfRegJavaNodeVisitor(JavaVM *_jvm, jobject _javaObject) : JavaCallback(_jvm, _javaObject) {}

    virtual ~DfRegJavaNodeVisitor()
    {}
...
(JNIEnv *env, jobject, jlong modAddr, jlong iTree, jobject visitor)
{
    ...
    DfRegJavaNodeVisitor visitorImpl(jvm, visitor);
