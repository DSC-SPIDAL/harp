...
services::Status LogisticKernel<algorithmFPType, method, cpu>::compute(const Tensor &inputTensor, Tensor &resultTensor, Tensor &forwardOutputTensor)
{
    ...
    Status s = computeImplStatus<cpu>(inputTensor, [=, &inputTensor, &resultTensor, &forwardOutputTensor](size_t fDimN, size_t *fDims, size_t nRowsToProcess, const TensorOffsetLayout &layout) -> Status
    {
