...
{
public:
    Status compute(const bernoulli::Parameter<algorithmFPType> &parameter, NumericTable *resultTable);
    Status computeInt(int *resultArray, size_t n, const bernoulli::Parameter<algorithmFPType> &parameter);
    Status computeFPType(NumericTable *resultTable, const bernoulli::Parameter<algorithmFPType> &parameter);
};
