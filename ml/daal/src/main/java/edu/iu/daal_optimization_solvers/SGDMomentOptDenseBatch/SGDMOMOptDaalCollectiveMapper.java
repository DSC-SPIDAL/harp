 ...
 */
public class SGDMOMOptDaalCollectiveMapper
	extends
	CollectiveMapper<String, String, Object, Object> {
		...
		protected void setup(Context context)
			...
			this.nIterations = configuration.getLong(HarpDAALConstants.NUM_ITERATIONS, 400);
		 ...
		 * @return 
		 */
		private void runSGDMOMOpt(Configuration conf, Context context) throws IOException 
		{
			// ---------- load data ----------
