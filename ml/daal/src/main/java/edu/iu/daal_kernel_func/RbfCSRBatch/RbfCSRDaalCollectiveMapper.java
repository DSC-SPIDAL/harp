 ...
 */
public class RbfCSRDaalCollectiveMapper
    extends
	...
	this.rightfilepath = configuration.get(Constants.RIGHT_FILE_PATH,"");
         ...
         * @return 
         */
        private void runRbfCSR(Configuration conf, Context context) throws IOException 
	{
		// // ---------- load data ----------
		NumericTable leftData  = this.datasource.loadCSRNumericTable(daal_Context); 
        	NumericTable rightData = this.datasource.loadExternalCSRNumericTable(rightfilepath, daal_Context); 

		/* Create an algorithm */
        com.intel.daal.algorithms.kernel_function.rbf.Batch algorithm = new com.intel.daal.algorithms.kernel_function.rbf.Batch(daal_Context, Double.class, com.intel.daal.algorithms.kernel_function.rbf.Method.fastCSR);
