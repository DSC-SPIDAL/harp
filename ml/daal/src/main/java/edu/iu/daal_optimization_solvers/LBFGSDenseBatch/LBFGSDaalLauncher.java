...
public class LBFGSDaalLauncher extends Configured
  implements Tool {
  ...
  public int run(String[] args) throws Exception {
      ...
      if (args.length < 9) {
      System.err
        .println("Usage: edu.iu.daal_svd.LBFGSDaalLauncher "
          + "<file dim > "
          + "<feature dim > "
	  + "<nIterations>"
	  + "<step_length>"
  ...
  private Job configureLBFGSJob(
    ...
    job.setJarByClass(LBFGSDaalLauncher.class);
    job
      .setMapperClass(LBFGSDaalCollectiveMapper.class);
