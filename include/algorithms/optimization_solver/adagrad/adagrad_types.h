...
{
    rngState = adagrad::lastOptionalData + 1, /*!< Memory block with random numbers generator state */
    optionalDataSize
};
/// @endcond
...
struct DAAL_EXPORT Parameter : public optimization_solver::iterative_solver::Parameter
{
    ...
    Parameter(
        ...
        data_management::NumericTablePtr learningRate_ = data_management::NumericTablePtr(new data_management::HomogenNumericTable<double>(1, 1, data_management::NumericTableIface::doAllocate, 0.01)),
