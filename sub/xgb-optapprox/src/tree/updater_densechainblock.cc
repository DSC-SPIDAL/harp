 ...
 * \file updater_HistMakerDenseCompactChainBlock.cc
...
DMLC_REGISTRY_FILE_TAG(updater_densechainblock);

template<typename TStats>
class HistMakerDenseCompactChainBlock: public BaseMaker {
 public:

 HistMakerDenseCompactChainBlock(){
 ...
 protected:
  ...
  struct HistEntry {
    typename HistMakerDenseCompactChainBlock<TStats>::HistUnit hist;
    unsigned istart;
   ...
   */
    class BuildHistTask: public tbb::task {
        TreeNode* root;
        HistMakerDenseCompactChainBlock* ctx;
        bool is_continuation;

    public:
        BuildHistTask( TreeNode* root_, HistMakerDenseCompactChainBlock* ctx_ ) : 
...
XGBOOST_REGISTER_TREE_UPDATER(HistMakerDenseCompactChainBlock, "grow_densechainblock")
.describe("Tree constructor that uses approximate global of histogram construction.")
.set_body([]() {
    return new HistMakerDenseCompactChainBlock<GradStats>();
  });
}  // namespace tree
}  // namespace xgboost
