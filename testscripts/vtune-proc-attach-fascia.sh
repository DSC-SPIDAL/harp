...
exe_dir=${CurDir}
scriptName=fascia_run_t-006.sh
...
# obj=R-Fascia-$Arch-$executor-$run_arg1-$run_arg2-$run_arg3-$action-$type-vectorization
# obj=R-Fascia-$Arch-$executor-$run_arg1-$run_arg2-$run_arg3-$action-$type-memcache
obj=R-Fascia-$Arch-$executor-$run_arg1-$run_arg2-$run_arg3-$action-$type
