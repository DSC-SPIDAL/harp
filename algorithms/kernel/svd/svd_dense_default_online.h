...
DAAL_EXPORT Status OnlinePartialResult::addPartialResultStorage(size_t m, size_t n, Parameter &par)
{
    data_management::DataCollectionPtr rCollection =
        staticPointerCast<data_management::DataCollection, data_management::SerializationIface>(Argument::get(outputOfStep1ForStep2));
    ...
    if(par.leftSingularMatrix != notRequired)
    {
        data_management::DataCollectionPtr qCollection =
            staticPointerCast<data_management::DataCollection,
