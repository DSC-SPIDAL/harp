...
public class EdgeVal extends Value {
	...
	System.arraycopy(edgeVal.getSrc(), 0, src, size, otherSize);
	System.arraycopy(edgeVal.getVal(), 0, val, size, otherSize);
	System.arraycopy(edgeVal.getDest(), 0, dest, size, otherSize);
	size += otherSize;
    }
