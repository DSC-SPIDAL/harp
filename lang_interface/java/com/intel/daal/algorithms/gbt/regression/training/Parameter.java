...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__GBT__REGRESSION__TRAINING__PARAMETER"></a>
 * @brief Base class for parameters of the gradient boosted trees regression training algorithm
 */
public class Parameter extends com.intel.daal.algorithms.Parameter {
    ...
    /**
     * Sets maximal number of iterations parameter of the gradient boosted trees training algorithm
    ...
    /**
     * Returns number of features tried as possible splits by the gradient boosted trees regression training algorithm
    ...
    /**
     * Sets the number of features tried as possible splits by gradient boosted trees regression training algorithm.
     * If 0 then p/3 is used, where p is the total number of features.
