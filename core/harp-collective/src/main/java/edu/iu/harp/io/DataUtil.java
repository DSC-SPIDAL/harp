...
/*******************************************************
 * The operations, including deserialization,
 * decoding and encoding on various type of data
 ******************************************************/
public class DataUtil {
  ...
  /**
   * Add the Data to EventQueue or DataMap. If the
   * Data is operation data, add it to the
