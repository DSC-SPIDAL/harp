                                                                              ...
                                                                              Model *r, const Parameter *par)
{
    ...
    HomogenNTPtr hTable(new HomogenNT(1, nVectors));
    HomogenNTPtr wTable(new HomogenNT(1, nVectors));
...
template <Method method, typename algorithmFPType, CpuType cpu>
NewtonRaphsonKernel<method, algorithmFPType, cpu>::NewtonRaphsonKernel(size_t nVect, Parameter *parameter):
    nVectors(nVect),
    aNra(nVectors),
    aNrb(nVectors),
    aNrd(nVectors),
