...
../bin/xgb-strongscale.sh ${bin} criteometa 10 8 lossguide 1562500 33 0 8 depth data_parallelism=1 group_parallel_cnt=32 topk=0 async_mixmode=2 loadmeta=criteometa
../bin/xgb-strongscale.sh ${bin} criteometa 10 12 lossguide 1562500 33 0 8 depth data_parallelism=1 group_parallel_cnt=32 topk=0 async_mixmode=2 loadmeta=criteometa
../bin/xgb-strongscale.sh ${bin} criteometa 10 16 lossguide 1562500 33 0 32 depth data_parallelism=1 group_parallel_cnt=32 topk=0 async_mixmode=2 loadmeta=criteometa
