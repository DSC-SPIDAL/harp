...
public class Utils {
  ...
  public static void
    printIntTable(List<OneDoc> docs) {
  ...
  public static void
    printIntTable(Table<IntArray> dataTable) {
  ...
  public static void printDoubleTable(
    Table<DoubleArray> dataTable) {
