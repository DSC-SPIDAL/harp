...
public class PartitionSet extends Writable {
     ...
     *            partition ID set
     */
    public void setParSet(IntArrayList partitionSet) {
	parIDs = partitionSet;
    }
    ...
    /**
     * Get the number of bytes of encoded data 4 for storing worker ID, 4 for
     * storing the size of parIDs, the rest for storing the parIDs
     */
    @Override
