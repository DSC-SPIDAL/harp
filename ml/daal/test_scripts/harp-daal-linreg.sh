...
echo "Test-daal-linreg-$Dataset-N$Node-T$Thd-B$Batch Start" 
hadoop jar harp-daal-app-1.0-SNAPSHOT.jar edu.iu.daal_linreg.LinRegDaalLauncher -libjars ${LIBJARS}  /Hadoop/reg-input/$Dataset/train /Hadoop/reg-input/$Dataset/test /Hadoop/reg-input/$Dataset/groundTruth /linreg/work $Mem $Batch $Node $Thd 2>$logDir/Test-daal-linreg-$Dataset-N$Node-T$Thd-B$Batch.log 
echo "Test-daal-linreg-$Dataset-N$Node-T$Thd-B$Batch End" 
