...
services::Status LogitBoostTrainKernel<friedman, algorithmFPType, cpu>::compute(const size_t na, NumericTablePtr a[], Model *r, const Parameter *par)
{
    ...
    trainInput->set(classifier::training::data,    x);
    trainInput->set(classifier::training::labels,  zTable);
    trainInput->set(classifier::training::weights, wTable);
    ...
    predictInput->set(classifier::prediction::data, x);
