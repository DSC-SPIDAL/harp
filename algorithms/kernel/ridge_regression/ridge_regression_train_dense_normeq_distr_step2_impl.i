...
Status RidgeRegressionTrainDistributedKernel<algorithmFPType, training::normEqDense, cpu>::compute(
...
template <typename algorithmFPType, CpuType cpu>
Status RidgeRegressionTrainDistributedKernel<algorithmFPType, training::normEqDense, cpu>::merge(
...
void RidgeRegressionTrainDistributedKernel<algorithmFPType, training::normEqDense, cpu>::mergePartialSums(
    DAAL_INT nBetas, DAAL_INT nResponses,
    algorithmFPType *axtx, algorithmFPType *axty,
    algorithmFPType *rxtx, algorithmFPType *rxty)
{
...
template <typename algorithmFPType, CpuType cpu>
Status RidgeRegressionTrainDistributedKernel<algorithmFPType, training::normEqDense, cpu>::finalizeCompute(
