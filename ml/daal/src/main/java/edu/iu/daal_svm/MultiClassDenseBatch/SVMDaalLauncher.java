...
public class SVMDaalLauncher extends Configured
    ...
    ExecutionException, ClassNotFoundException 
  {
    ...
    runSVMMultiDense(nFeature, nFileDim, nClass, 
		    numMapTasks, numThreads, mem, trainDataDir, testDataDir, dataDir, outDir, configuration);

    long endTime = System.currentTimeMillis();
    System.out
      .println("Total SVM Multi Dense Execution Time: "
        + (endTime - startTime));
  }

  private void runSVMMultiDense(
    ...
    Job svmJob =
      configureSVMJob(nFeature, nFileDim, nClass, 
		    numMapTasks, numThreads, mem, trainDataDir, testDataDir, dataDir, outDir, configuration);
