...
echo "Test-$Arch-daal-sgd-$Dataset-D$Dim-N$Node-T$Thd-ITR$Itr-Timer-$Tune Start" 
bin/hadoop jar harp-daal-app-1.0-SNAPSHOT.jar edu.iu.daal_sgd.SGDDaalLauncher -libjars ${LIBJARS} /Hadoop/sgd-input/$Dataset $Dim $Lambda $Epsilon $Itr $Tune $Node $Thd $Mem /Hadoop/sgd-work /Hadoop/sgd-input/$Testset 2>$logDir/Test-$Arch-daal-sgd-$Dataset-D$Dim-N$Node-T$Thd-ITR$Itr-Timer-$Tune.log
echo "Test-$Arch-daal-sgd-$Dataset-D$Dim-N$Node-T$Thd-ITR$Itr-Timer-$Tune End" 
