...
import com.intel.daal.algorithms.optimization_solver.sgd.ParameterMiniBatch;
 ...
 */
public class SGDMINIDaalCollectiveMapper extends CollectiveMapper<String, String, Object, Object> 
{
	 ...
	 * @return 
	 */
	private void runSGDMINI(Context context) throws IOException 
	{
		// ---------- load data ----------
		...
		Batch sgdAlgorithm = new Batch(daal_Context, Double.class, Method.miniBatch);
