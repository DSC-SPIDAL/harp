...
struct MklStatistics<double, cpu>
{
    ...
    static int xQuantiles(const double *data, const __int64 nFeatures, const __int64 nVectors, const __int64 quantOrderN, const double* quantOrder, double *quants)
    {
        DAAL_VSLSSTaskPtr task;
        int errcode = 0;
...
struct MklStatistics<float, cpu>
{
    ...
    static int xQuantiles(const float *data, const __int64 nFeatures, const __int64 nVectors, const __int64 quantOrderN, const float* quantOrder, float *quants)
    {
        DAAL_VSLSSTaskPtr task;
        int errcode = 0;
