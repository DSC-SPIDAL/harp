...
import com.intel.daal.algorithms.decision_tree.classification.prediction.PredictionBatch;
import com.intel.daal.algorithms.decision_tree.classification.prediction.PredictionMethod;
 ...
 */
public class DTCLSDaalCollectiveMapper
    extends
	...
	LOG.info("File Dim " + this.fileDim);
         ...
         * @return 
         */
        private void runDTCLS(Context context) throws IOException 
	{
