...
/**
 * @brief A derivative class of the HarpTensorImpl class, that provides implementation
 *        of a Harp tensor with data stored as array of primitives
 */
class HarpTensorArrayImpl extends HarpTensorImpl {
    ...
    /** @copydoc HarpTensor::HarpTensor(DaalContext,long[],double[]) */
    public HarpTensorArrayImpl(DaalContext context, long[] dims,  double[] data) {
        super(context);
        initialize(context, Double.class, dims, data);
    }

    /** @copydoc HarpTensor::HarpTensor(DaalContext,long[],float[]) */
    public HarpTensorArrayImpl(DaalContext context, long[] dims,  float[] data) {
        super(context);
        initialize(context, Float.class, dims, data);
    }

    /** @copydoc HarpTensor::HarpTensor(DaalContext,long[],int[]) */
    public HarpTensorArrayImpl(DaalContext context, long[] dims,  int[] data) {
        super(context);
        initialize(context, Integer.class, dims, data);
    }

    /** @copydoc HarpTensor::HarpTensor(DaalContext,long[],long[]) */
    public HarpTensorArrayImpl(DaalContext context, long[] dims,  long[] data) {
        super(context);
        initialize(context, Long.class, dims, data);
    }

    /** @copydoc HarpTensor::HarpTensor(DaalContext,long[],double[],double) */
    public HarpTensorArrayImpl(DaalContext context, long[] dims,  double[] data, double constValue) {
        super(context);
        initialize(context, Double.class, dims, data);
        assign(constValue);
    }

    /** @copydoc HarpTensor::HarpTensor(DaalContext,long[],float[],float) */
    public HarpTensorArrayImpl(DaalContext context, long[] dims,  float[] data, float constValue) {
        super(context);
        initialize(context, Float.class, dims, data);
        assign(constValue);
    }

    /** @copydoc HarpTensor::HarpTensor(DaalContext,long[],int[],int) */
    public HarpTensorArrayImpl(DaalContext context, long[] dims,  int[] data, int constValue) {
        super(context);
        initialize(context, Integer.class, dims, data);
        assign(constValue);
    }

    /** @copydoc HarpTensor::HarpTensor(DaalContext,long[],long[],long) */
    public HarpTensorArrayImpl(DaalContext context, long[] dims,  long[] data, long constValue) {
        super(context);
        initialize(context, Long.class, dims, data);
        assign(constValue);
    }
    ...
    /** @copydoc HarpTensor::getDataObject() */
    @Override
    public Object getDataObject() {
        return jData;
    }

    /** @copydoc HarpTensor::getNumericType() */
    @Override
    ...
    public void allocateDataMemory() {
        throw new IllegalArgumentException("can not allocate data memory in Harp Tensor with data on Java side");
    }
    ...
    private void initialize(DaalContext context, Class<? extends Number> cls, long[] dims, Object data) {
        type = cls;
        cObject = newJavaHarpTensor(dims, SerializationTag.SERIALIZATION_JAVANIO_HARP_TENSOR_ID);
        jData = data;
    ...
    protected void onUnpack(DaalContext context) {
        if (this.cObject == 0) {
            cObject = newJavaHarpTensor(serializedDims, SerializationTag.SERIALIZATION_JAVANIO_HARP_TENSOR_ID);
        }
    }

    private long newJavaHarpTensor(long[] newDims, SerializationTag tag) {
        return cNewJavaHarpTensor(newDims, tag.getValue());
    }

    private native long cNewJavaHarpTensor(long[] newDims, int tag);
