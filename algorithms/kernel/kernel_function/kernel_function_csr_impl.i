...
algorithmFPType computeDotProductBaseline(
    const size_t startIndexA, const size_t endIndexA, const algorithmFPType *valuesA, const size_t *indicesA,
...
algorithmFPType KernelCSRImplBase<algorithmFPType, cpu>::computeDotProduct(
    ...
    const size_t startIndexB, const size_t endIndexB, const algorithmFPType *valuesB, const size_t *indicesB)
{
    return computeDotProductBaseline<algorithmFPType, cpu>(startIndexA, endIndexA, valuesA, indicesA,
                                                           startIndexB, endIndexB, valuesB, indicesB);
}
  ...
  #undef __DAAL_IA32e
    ...
    template <>
    double KernelCSRImplBase<double, avx512_mic>::computeDotProduct(
        const size_t startIndexA, const size_t endIndexA, const double *valuesA, const size_t *indicesA,
        const size_t startIndexB, const size_t endIndexB, const double *valuesB, const size_t *indicesB)
    {
        size_t offsetA = startIndexA;
        size_t offsetB = startIndexB;
        double sum = 0.0;
        ...
        if (offsetA + 8 <= endIndexA && offsetB + 8 <= endIndexB &&
            !(endIndexA & 0xffffffff00000000) && !(endIndexB & 0xffffffff00000000))
        {
        ...
        sum += computeDotProductBaseline<double, avx512_mic>(
                    offsetA, endIndexA, valuesA, indicesA,
                    offsetB, endIndexB, valuesB, indicesB);

        return sum;
    }

    template <>
    float KernelCSRImplBase<float, avx512_mic>::computeDotProduct(
        const size_t startIndexA, const size_t endIndexA, const float *valuesA, const size_t *indicesA,
        const size_t startIndexB, const size_t endIndexB, const float *valuesB, const size_t *indicesB)
    {
        size_t offsetA = startIndexA;
        size_t offsetB = startIndexB;
        double sum = 0.0;
        ...
        /* Process tail elements in scalar loop */
        sum += computeDotProductBaseline<float, avx512_mic>(
                    offsetA, endIndexA, valuesA, indicesA,
                    offsetB, endIndexB, valuesB, indicesB);
    ...
    template <>
    double KernelCSRImplBase<double, avx512>::computeDotProduct(
        const size_t startIndexA, const size_t endIndexA, const double *valuesA, const size_t *indicesA,
        const size_t startIndexB, const size_t endIndexB, const double *valuesB, const size_t *indicesB)
    {
        size_t offsetA = startIndexA;
    ...
    template <>
    float KernelCSRImplBase<float, avx512>::computeDotProduct(
        const size_t startIndexA, const size_t endIndexA, const float *valuesA, const size_t *indicesA,
        const size_t startIndexB, const size_t endIndexB, const float *valuesB, const size_t *indicesB)
    {
        size_t offsetA = startIndexA;
