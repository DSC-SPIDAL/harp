 ...
 * @brief Provides methods to access final results obtained with the compute() method of subgraph algorithm
...
public class Result extends com.intel.daal.algorithms.Result {
    ...
    public NumericTable get(ResultId id) {
        // if (id != ResultId.resWMat && id != ResultId.resHMat) {
    ...
    /**
     * Sets the result of the subgraph algorithm
     * @param id    Identifier of the result
