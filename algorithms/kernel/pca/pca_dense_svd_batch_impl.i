...
services::Status PCASVDBatchKernel<algorithmFPType, cpu>::compute(InputDataType type,
...
template <typename algorithmFPType, CpuType cpu>
services::Status PCASVDBatchKernel<algorithmFPType, cpu>::normalizeDataset(const data_management::NumericTablePtr& data,
    NumericTablePtr& normalizedData)
{
    ...
    HomogenNumericTableCPU<algorithmFPType, cpu> *normalized = new HomogenNumericTableCPU<algorithmFPType, cpu>(nFeatures, nObservations);
    normalized->assign(0);
...
template <typename algorithmFPType, CpuType cpu>
services::Status PCASVDBatchKernel<algorithmFPType, cpu>::decompose(const NumericTable *normalizedDataTable,
