...
{
    set(prediction, data_management::NumericTablePtr(new data_management::HomogenNumericTable<algorithmFPType>(1, (static_cast<const InputIface *>(input))->getNumberOfRows(),
