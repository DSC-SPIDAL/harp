...
(JNIEnv *env, jobject thisobj, jlong nDim, jint layout)
{
    ...
    {
        tbl = PackedSymmetricMatrix<NumericTableIface::StorageLayout::upperPackedSymmetricMatrix, double>::create(nDim,
            NumericTableIface::AllocationFlag::doNotAllocate, &s);
    }
    else
    {
        tbl = PackedSymmetricMatrix<NumericTableIface::StorageLayout::lowerPackedSymmetricMatrix, double>::create(nDim,
            NumericTableIface::AllocationFlag::doNotAllocate, &s);
    }
    if(!s)
    {
...
(JNIEnv *env, jobject thisobj, jlong nDim, jint layout)
{
    ...
    if(layout == NumericTableIface::StorageLayout::upperPackedSymmetricMatrix)
    {
        tbl = PackedSymmetricMatrix<NumericTableIface::StorageLayout::upperPackedSymmetricMatrix, float>::create(nDim,
            NumericTableIface::AllocationFlag::doNotAllocate, &s);
    }
    else
    {
        tbl = PackedSymmetricMatrix<NumericTableIface::StorageLayout::lowerPackedSymmetricMatrix, float>::create(nDim,
            NumericTableIface::AllocationFlag::doNotAllocate, &s);
    }
    if(!s)
    {
...
(JNIEnv *env, jobject thisobj, jlong nDim, jint layout)
{
    ...
    if(layout == NumericTableIface::StorageLayout::upperPackedSymmetricMatrix)
    {
        tbl = PackedSymmetricMatrix<NumericTableIface::StorageLayout::upperPackedSymmetricMatrix, long>::create(nDim,
            NumericTableIface::AllocationFlag::doNotAllocate, &s);
    }
    else
    {
        tbl = PackedSymmetricMatrix<NumericTableIface::StorageLayout::lowerPackedSymmetricMatrix, long>::create(nDim,
            NumericTableIface::AllocationFlag::doNotAllocate, &s);
    }
    if(!s)
    {
...
(JNIEnv *env, jobject thisobj, jlong nDim, jint layout)
{
    ...
    if(layout == NumericTableIface::StorageLayout::upperPackedSymmetricMatrix)
    {
        tbl = PackedSymmetricMatrix<NumericTableIface::StorageLayout::upperPackedSymmetricMatrix, int>::create(nDim,
            NumericTableIface::AllocationFlag::doNotAllocate, &s);
    }
    else
    {
        tbl = PackedSymmetricMatrix<NumericTableIface::StorageLayout::lowerPackedSymmetricMatrix, int>::create(nDim,
            NumericTableIface::AllocationFlag::doNotAllocate, &s);
    }
    if(!s)
    {
