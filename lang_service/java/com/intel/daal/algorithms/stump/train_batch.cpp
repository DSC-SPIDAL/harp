...
#include <jni.h>/* Header for class com_intel_daal_algorithms_stump_training_TrainingBatch */

#include "daal.h"
#include "stump/training/JTrainingBatch.h"

#include "common_helpers.h"

USING_COMMON_NAMESPACES();
using namespace daal::algorithms::stump::training;

/*
 * Class:     com_intel_daal_algorithms_stump_training_TrainingBatch
 * Method:    cInit
 * Signature:(II)J
 */
