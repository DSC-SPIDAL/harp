...
DAAL_EXPORT services::Status Result::allocate(const daal::algorithms::Input *input, const daal::algorithms::Parameter *parameter, const int method)
{
    ...
    set(classifier::training::model, svm::ModelPtr(
            new svm::Model(dummy, algInput->get(classifier::training::data)->getNumberOfColumns(), algInput->get(classifier::training::data)->getDataLayout())));
