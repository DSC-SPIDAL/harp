...
public:
    ...
    ModelNormEqInternal(size_t featnum, size_t nrhs, const linear_regression::Parameter &par, modelFPType dummy);
...
public:
     ...
     */
    template <typename modelFPType>
    ModelNormEqImpl(size_t featnum, size_t nrhs, const linear_regression::Parameter &par, modelFPType dummy) :
