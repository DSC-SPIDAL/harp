...
logName=Test-daal-svd-P$Pts-D$Dim-F$File-N$Node-T$Thd.log

echo "Test-daal-svd-P$Pts-D$Dim-F$File-N$Node-T$Thd Start" 
hadoop jar harp-daal-0.1.0.jar edu.iu.daal_svd.SVDDaalLauncher -libjars ${LIBJARS} $Node $Thd $Mem $nIterations /Hadoop/svd-input/Svd-P$Pts-D$Dim-F$File-N$Node /Hadoop/svd-work $Dim $Dim $GenData $Pts $File /tmp/SVD 2>$logDir/${logName}
