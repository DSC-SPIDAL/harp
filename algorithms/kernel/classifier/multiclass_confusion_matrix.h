...
DAAL_EXPORT services::Status Result::allocate(const daal::algorithms::Input *input, const daal::algorithms::Parameter *parameter, const int method)
{
    ...
    set(confusionMatrix, data_management::NumericTablePtr(new data_management::HomogenNumericTable<algorithmFPType>(nClasses, nClasses,
                                                          data_management::NumericTableIface::doAllocate)));

    set(multiClassMetrics, data_management::NumericTablePtr(new data_management::HomogenNumericTable<algorithmFPType>(8, 1,
                                                            data_management::NumericTableIface::doAllocate)));
