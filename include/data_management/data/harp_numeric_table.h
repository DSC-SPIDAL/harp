...
public:
     ...
     *  \DAAL_DEPRECATED_USE{ HarpNumericTable::create }
     */
    HarpNumericTable(size_t nColumns = 0, size_t nRows = 0, DictionaryIface::FeaturesEqual featuresEqual = DictionaryIface::notEqual);
     ...
     */
    static services::SharedPtr<HarpNumericTable> create(size_t nColumns = 0, size_t nRows = 0,
     ...
     *  \DAAL_DEPRECATED
     */
    DAAL_DEPRECATED HarpNumericTable( NumericTableDictionary *ddict, size_t nRows, AllocationFlag memoryAllocationFlag = notAllocate ):
     ...
     *  \DAAL_DEPRECATED_USE{ HarpNumericTable::create }
     */
    HarpNumericTable( NumericTableDictionaryPtr ddict, size_t nRows, AllocationFlag memoryAllocationFlag = notAllocate );
     ...
     */
    static services::SharedPtr<HarpNumericTable> create(NumericTableDictionaryPtr ddict, size_t nRows,
                                                       AllocationFlag memoryAllocationFlag = notAllocate,
                                                       services::Status *stat = NULL);

    virtual ~HarpNumericTable()
    {
        freeDataMemoryImpl();
    }
...
protected:
    HarpNumericTable( size_t nColumns, size_t nRows, DictionaryIface::FeaturesEqual featuresEqual, services::Status &st );

    HarpNumericTable( NumericTableDictionaryPtr ddict, size_t nRows, AllocationFlag memoryAllocationFlag, services::Status &st );
