/* file: neural_networks_training_dense_feedforward_distr_step1_fpt_cpu.cpp */
/*******************************************************************************
...
{
template class neural_networks::training::DistributedContainer<step1Local, DAAL_FPTYPE, feedforwardDense, DAAL_CPU>;
}
namespace internal
{
