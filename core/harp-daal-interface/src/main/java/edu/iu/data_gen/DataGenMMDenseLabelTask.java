 ...
 */
public class DataGenMMDenseLabelTask implements Runnable {
   ...
   */
  public DataGenMMDenseLabelTask(int pointsPerFile,
                                 String localInputDir, String fileName,
                                 int vectorSize, int labelRange, String sep) {
    ...
    try {
      ...
      for (int i = 0; i < pointsPerFile; i++) {
        ...
        for (int j = 0; j < vectorSize; j++) {
          ...
          point = random.nextInt(this.labelRange);
