...
make clean_all
make -j 24  USE_VTUNE=0 USE_SPLIT_PARALLELONNODE=1 USE_HALFTRICK_EX=1 USE_SPARSE_DMATRIX=0 USE_BLKADDR_BYTE=1 USE_MIXMODE=1 USE_DEBUG=0 DEBUG=0 TAGNAME=$tagname
