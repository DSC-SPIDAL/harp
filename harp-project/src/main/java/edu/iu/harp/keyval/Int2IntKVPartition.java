...
/*******************************************************
 * Int2IntKVPartition manages key-value pairs in which the key and the value are
 * int-type
 ******************************************************/
public class Int2IntKVPartition extends KVPartition {

    private Int2IntOpenHashMap kvMap;
    final static int defaultReturnVal = Integer.MIN_VALUE;
     ...
     */
    public ValStatus putKeyVal(int key, int val, TypeIntCombiner combiner) {
	...
	ObjectIterator<Int2IntMap.Entry> iterator = kvMap.int2IntEntrySet().fastIterator();
	...
	if (kvMap != null) {
	    ...
	    this.kvMap.defaultReturnValue(defaultReturnVal);
	}
