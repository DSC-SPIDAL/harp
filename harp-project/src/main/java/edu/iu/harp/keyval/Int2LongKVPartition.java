...
/*******************************************************
 * Int2LongKVPartition manages key-value pairs in which the key is int-type and
 * the value is long-type
 ******************************************************/
public class Int2LongKVPartition extends KVPartition {

    private Int2LongOpenHashMap kvMap;
    final static long defaultReturnVal = Long.MIN_VALUE;
	...
	if (curVal == defaultReturnVal) {
	    ...
	    this.kvMap.put(key, combiner.combine(curVal, val));
	...
	ObjectIterator<Int2LongMap.Entry> iterator = kvMap.int2LongEntrySet().fastIterator();
