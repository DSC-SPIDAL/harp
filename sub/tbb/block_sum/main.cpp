...
int main( int argc, const char *argv[] ) {
    ...
    try{
        ...
        long number_of_nodes = 10 * 1024 * 1024;
        int blocksize = 256*1024;
        long number_of_features = 28;
        bool silent = false;
        bool use_stdmalloc = false;

        number_of_nodes = 10 * 1000 * 1000;
        blocksize = 256 * 1024;
        ...
        utility::parse_cli_arguments(argc,argv,
            ...
            .positional_arg(number_of_nodes,"blocksize","the blocksize")
            .positional_arg(number_of_nodes,"number-of-nodes","the number of nodes")
            .positional_arg(number_of_nodes,"number-of-features","the number of features")
        ...
        //init the problem
        DMatrix dmat;
        dmat.init(number_of_features, number_of_nodes);
        ...
        { // In this scope, TBB will use default number of threads for tree creation
            ...
            if( use_stdmalloc ) {
                ...
                root = TreeMaker<stdmalloc>::create_and_time( dmat,blocksize, silent );
            } else {
                if ( !silent ) printf("Tree creation using TBB scalable allocator\n");
                root = TreeMaker<tbbmalloc>::create_and_time( dmat,blocksize, silent );
            }
        }
