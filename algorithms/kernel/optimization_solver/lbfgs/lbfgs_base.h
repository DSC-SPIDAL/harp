...
public:
    ...
    */
    Status computeCorrectionPair(size_t correctionIndex, NumericTable* hessian);

    void computeCorrectionPairImpl(size_t correctionIndex, const algorithmFPType *hessian);
...
private:
    ...
    */
    Status initRngState(OptionalArgument *optionalArgumentInput, const Parameter* parameter);
