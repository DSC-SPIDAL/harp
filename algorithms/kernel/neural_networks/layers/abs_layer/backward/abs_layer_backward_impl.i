...
services::Status AbsKernel<algorithmFPType, method, cpu>::compute(const Tensor &inputTensor, const Tensor &dataTensor, Tensor &resultTensor)
{
    ...
    s = computeImplStatus<cpu>(inputTensor, [=, &inputTensor, &dataTensor, &resultTensor](size_t fDimN, size_t *fDims, size_t nRowsToProcess, const TensorOffsetLayout &layout) -> Status
    {
