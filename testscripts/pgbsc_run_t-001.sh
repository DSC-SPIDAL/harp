...
for graph_file in orkut.graph miami.graph 
# for graph_file in nyc.graph
# for graph_file in graph500-scale20-ef16_adj.mmio graph500-scale21-ef16_adj.mmio graph500-scale22-ef16_adj.mmio graph500-scale23-ef16_adj.mmio
