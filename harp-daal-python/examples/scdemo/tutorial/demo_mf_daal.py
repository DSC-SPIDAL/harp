...
from daal_mfsgd import DAALMFSGD
#*******************************************************
...
algo = DAALMFSGD(n_node = 1, n_thread = 8, n_factors = 100, n_epochs = 20, lr_all = 0.005, reg_all = 0.02)
#measures=['RMSE', 'MAE']
measures=['RMSE']
verbose = True
...
for fold_i, (trainset, testset) in enumerate(data.folds()):
    ...
    rmse = algo.train_test('ml-1m_train_%d.mm'%fold_i, 'ml-1m_test_%d.mm'%fold_i)
    #==================================================================
    ...
    for measure in measures:
        ...
        performances[measure].append(float(rmse))
