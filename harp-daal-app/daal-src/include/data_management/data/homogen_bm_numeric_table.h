...
#ifndef __HOMOGEN_BM_NUMERIC_TABLE_H__
#define __HOMOGEN_BM_NUMERIC_TABLE_H__
 ...
 */
/**
 *  <a name="DAAL-CLASS-DATA_MANAGEMENT__HomogenBMNumericTable"></a>
...
class HomogenBMNumericTable : public NumericTable
{
public:
    DAAL_CAST_OPERATOR(HomogenBMNumericTable)
    /**
...
public:
     ...
     */
    HomogenBMNumericTable( NumericTableDictionary *ddict ):
     ...
     *  \param[in]  ddict   Pointer to the predefined NumericTableDictionary
     */
    HomogenBMNumericTable( services::SharedPtr<NumericTableDictionary> ddict ):
        NumericTable(ddict), _ptr(0)
    {
        _layout = aos;
    }
     ...
     */
    HomogenBMNumericTable( DataType *const ptr = 0, size_t nColumns = 0, size_t nRows = 0 ):
     ...
     */
    HomogenBMNumericTable( DataType *const ptr, size_t nColumns, size_t nRows, const DataType &constValue ):
        NumericTable( nColumns, nRows ), _ptr(0)
    {
        _layout = aos;
        setArray( ptr );
     ...
     */
    HomogenBMNumericTable( size_t nColumns, size_t nRows, AllocationFlag memoryAllocationFlag ):
        NumericTable( nColumns, nRows ), _ptr(0)
    {
        _layout = aos;
     ...
     *  \param[in]  constValue              Constant to initialize entries of the homogeneous numeric table
     */
    HomogenBMNumericTable( size_t nColumns, size_t nRows, NumericTable::AllocationFlag memoryAllocationFlag,
    ...
    void assign( const DataType &constValue )
    {
        ...
        {
            this->_errors->add(services::ErrorEmptyHomogenBMNumericTable);
            return;
        }
...
using interface1::HomogenBMNumericTable;
