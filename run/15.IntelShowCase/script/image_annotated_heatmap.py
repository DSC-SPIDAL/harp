...
#fig.tight_layout()
#plt.show()
data = np.loadtxt('blocksize.txt') 

#fig, ax = plt.subplots(1,1, figsize=(8,6))
#fig, ax = plt.subplots(1,1, figsize=(4,3))
fig, ax = plt.subplots()
size=[1,4,8,16,32]
y = ["NodeBlockSize {}".format(i) for i in size]
x = ["FeatureBlockSize {}".format(i) for i in size]

im, _ = heatmap(data, y, x, ax=ax, vmin=0,
#cmap="magma_r", cbarlabel="Speedup of Training Time")
                cmap="coolwarm", cbarlabel="Speedup of Training Time")
annotate_heatmap(im, valfmt="{x:.2f}", size=5, threshold=1.0,
                 textcolors=["black", "white"])

#
#
#im, _ = heatmap(data, y, x, ax=ax, vmin=0,
#                cmap="Wistia", cbarlabel="Speedup of Training Time")
#annotate_heatmap(im, valfmt="{x:.2f}", size=5)
##, threshold=20,               textcolors=["red", "white"])
...
y = ["NodeBlockSize {}".format(i) for i in range(1, 5)]
x = ["FeatureBlockSize {}".format(i) for i in range(1, 5)]
im, _ = heatmap(data, y, x, ax=ax, vmin=0,
                cmap="Wistia", cbarlabel="Speedup of Training Time")
annotate_heatmap(im, valfmt="{x:.2f}", size=5, threshold=20,
