...
../bin/xgb-convergence.sh ${bin} higgs 1000 8  hist 32 500000 1 0 8 lossguide
#../bin/xgb-convergence.sh ${bin} higgs 1000 12  hist 32 500000 1 0 64 lossguide
#../bin/xgb-convergence.sh ${bin} higgs 1000 16  hist 32 500000 1 0 64 lossguide
